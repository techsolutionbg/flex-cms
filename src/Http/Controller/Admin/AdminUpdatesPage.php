...
final class AdminUpdatesPage
{
    ...
    public function render(string $csrfToken, array $history, ?string $notice = null, ?string $error = null, ?array $inspection = null): string
    {
        ...
        <header><div class="brand">Flex CMS · Updates</div><a class="back" href="/admin">← Административен панел</a></header><main><h1>Обновявания</h1><p class="lead">Качете ZIP пакет за версията и стартирайте контролирано обновяване с един бутон.</p>{$noticeMarkup}{$errorMarkup}{$inspectionMarkup}
